/*
  ...
  - You are about to drop the column `mericUnit` on the `Habit` table. All the data in the column will be lost.
  - Added the required column `metric` to the `Habit` table without a default value. This is not possible if the table is not empty.
